...
public class NoteUtil{
    ...
    public  static String sendSms(String telephone) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("微享云音");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_173251821");
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber("17326251663");
        //可选-流水号
...
//    String code = UUID.randomUUID().toString().replaceAll("-","").substring(0,6);
//
//    System.out.println("{\"name\":\"Tom\", \"code\":\""+code+"\"}");
    NoteUtil.sendSms("17326251663");
}
}
